...
**mem_total** | **int** | Total amount of physical memory available on the host, in kilobytes (kB). | [optional] 
...
**server_version** | **string** | Version string of the daemon.  &gt; **Note**: the [standalone Swarm API](https://docs.docker.com/swarm/swarm-api/) &gt; returns the Swarm version instead of the daemon  version, for example &gt; &#x60;swarm/1.2.8&#x60;. | [optional] 
