...
> \OpenAPI\Client\Model\ContainerChangeResponseItem[] containerChanges($id)
...
> \OpenAPI\Client\Model\ContainerCreateResponse containerCreate($body, $name)
...
> \OpenAPI\Client\Model\ContainerInspectResponse containerInspect($id, $size)
...
> \OpenAPI\Client\Model\ContainerPruneResponse containerPrune($filters)
...
> \OpenAPI\Client\Model\ContainerTopResponse containerTop($id, $ps_args)
...
> \OpenAPI\Client\Model\ContainerUpdateResponse containerUpdate($id, $update)
...
> \OpenAPI\Client\Model\ContainerWaitResponse containerWait($id, $condition)
...
$input_stream = "/path/to/file.txt"; // \SplFileObject | The input stream must be a tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz.
 ...
 **input_stream** | **\SplFileObject****\SplFileObject**| The input stream must be a tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz. |
