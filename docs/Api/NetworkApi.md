...
> \OpenAPI\Client\Model\NetworkCreateResponse networkCreate($network_config)
...
> \OpenAPI\Client\Model\Network networkInspect($id, $verbose, $scope)
...
> \OpenAPI\Client\Model\Network[] networkList($filters)
...
> \OpenAPI\Client\Model\NetworkPruneResponse networkPrune($filters)
