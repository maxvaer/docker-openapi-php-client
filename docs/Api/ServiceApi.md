...
> \OpenAPI\Client\Model\ServiceCreateResponse serviceCreate($body, $x_registry_auth)
...
> \OpenAPI\Client\Model\Service serviceInspect($id, $insert_defaults)
...
> \OpenAPI\Client\Model\Service[] serviceList($filters)
...
> \OpenAPI\Client\Model\ServiceUpdateResponse serviceUpdate($id, $version, $body, $registry_auth_from, $rollback, $x_registry_auth)
