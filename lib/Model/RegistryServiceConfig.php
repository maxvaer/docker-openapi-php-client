...
class RegistryServiceConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'index_configs' => 'map[string,\OpenAPI\Client\Model\IndexInfo]',
        'mirrors' => 'string[]'
    ];
     ...
     * Gets index_configs
     *
     * @return map[string,\OpenAPI\Client\Model\IndexInfo]|null
     */
     ...
     * Sets index_configs
     *
     * @param map[string,\OpenAPI\Client\Model\IndexInfo]|null $index_configs index_configs
     *
     * @return $this
     */
