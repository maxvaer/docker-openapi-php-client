...
class SystemInfo implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'runtimes' => 'map[string,\OpenAPI\Client\Model\Runtime]',
     ...
     * Sets system_status
     *
     * @param string[][]|null $system_status Status information about this node (standalone Swarm API).  <p><br /></p>  > **Note**: The information returned in this field is only propagated > by the Swarm standalone API, and is empty (`null`) when using > built-in swarm mode.
     *
     * @return $this
     */
     ...
     * Sets kernel_memory
     *
     * @param bool|null $kernel_memory Indicates if the host has kernel memory limit support enabled.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $i_pv4_forwarding Indicates IPv4 forwarding is enabled.
     *
     * @return $this
     */
     ...
     * Sets n_fd
     *
     * @param int|null $n_fd The total number of file Descriptors in use by the daemon process.  This information is only returned if debug-mode is enabled.
     *
     * @return $this
     */
     ...
     * Sets mem_total
     *
     * @param int|null $mem_total Total amount of physical memory available on the host, in kilobytes (kB).
     *
     * @return $this
     */
     ...
     * Sets server_version
     *
     * @param string|null $server_version Version string of the daemon.  > **Note**: the [standalone Swarm API](https://docs.docker.com/swarm/swarm-api/) > returns the Swarm version instead of the daemon  version, for example > `swarm/1.2.8`.
     *
     * @return $this
     */
     ...
     * Gets runtimes
     *
     * @return map[string,\OpenAPI\Client\Model\Runtime]|null
     */
