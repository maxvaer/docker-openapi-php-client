...
class HostConfig implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'network_mode' => 'string',
        'port_bindings' => 'map[string,\OpenAPI\Client\Model\PortBinding[]]',
     ...
     * Sets kernel_memory
     *
     * @param int|null $kernel_memory Kernel memory limit in bytes.
     *
     * @return $this
     */
     ...
     * Sets nano_cp_us
     *
     * @param int|null $nano_cp_us CPU quota in units of 10<sup>-9</sup> CPUs.
     *
     * @return $this
     */
     ...
     * Sets storage_opt
     *
     * @param map[string,string]|null $storage_opt Storage driver options for this container, in the form `{\"size\": \"120G\"}`.
     *
     * @return $this
     */
