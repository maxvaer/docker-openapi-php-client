...
class EndpointSettings implements ModelInterface, ArrayAccess
{
     ...
     * Sets i_pv6_gateway
     *
     * @param string|null $i_pv6_gateway IPv6 gateway address.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $global_i_pv6_address Global IPv6 address.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $global_i_pv6_prefix_len Mask length of the global IPv6 address.
     *
     * @return $this
     */
     ...
     * Sets driver_opts
     *
     * @param map[string,string]|null $driver_opts DriverOpts is a mapping of driver options and values. These options are passed directly to the driver and are driver specific.
     *
     * @return $this
     */
