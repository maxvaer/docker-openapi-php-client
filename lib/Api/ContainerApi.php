...
class ContainerApi
{
     ...
     * @param  \SplFileObject $input_stream The input stream must be a tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz. (required)
